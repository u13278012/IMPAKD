...
%Priscilla Madigoe's Section - start
...
We are planning on using the following technologies for the project:
	\begin{itemize}
		...
		\\
		\item We will use Xamarin to natively code Android and IOS applications in C#
	\end{itemize}

\bigskip
 \item {\large \underline{\textbf{What CSIR will Receive}}}\\[0.2cm]
In addition to receiving the expected project deliverables, CSIR will receive a potential Android and IOS application. 
\end{itemize}
