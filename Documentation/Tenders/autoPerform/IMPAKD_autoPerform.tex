...
We are planning on using the following technologies for the project:
	\begin{itemize}
		...
		\\
		\item \underline{Front-end: Android} We will use the REST model to send data to and from the mobile application. 			The specific REST API framework we will use is
	\end{itemize}

\bigskip
 \item {\large \underline{\textbf{What Magna BC will Receive}}}\\[0.2cm]
In addition to the given project deliverables, the Magna BC 
\end{itemize}
\end{document}
