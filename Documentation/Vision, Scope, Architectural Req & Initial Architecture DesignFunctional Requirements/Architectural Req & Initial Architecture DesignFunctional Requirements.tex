...
\subsubsection{Quality requirements}
	\begin{itemize}
		...
		The system will be implemented with the Model View Controller structural pattern, which allows for modularisation. This 			allows the different components of the system to be maintained independently of each other. We will use Ember.js, a 			widely-used technology with extensive support, to implement MVC.
