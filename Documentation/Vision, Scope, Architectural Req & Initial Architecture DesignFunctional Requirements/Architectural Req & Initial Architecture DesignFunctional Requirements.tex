...
\item Java EE
	\begin{itemize}
		\item Java EE contains most of the frameworks and technologies we need to develop and deploy our system.
	\end{itemize}
...
\textbf{Technologies}
\begin{itemize}
	\item HTML5 : It will be used to create the front end of the system
\end{itemize}
\begin{itemize}
	\item Javascript :front end to verify the log in details for each user it will keep track of the user logged in.
\end{itemize}
\begin{itemize}
	\item JPA: It will be used to manage the relational data in JavaEE
\end{itemize}
\begin{itemize}
	\item EJBs: It will be used to manage concurrency control in the system
\end{itemize}
\begin{itemize}
	\item Ember.JS: To implement the MVC patten
\end{itemize}
\begin{itemize}
	\item Django: To implement the MVC Patten
\end{itemize}
\begin{itemize}
	\item CSS: It will be used for the styling of the web page
\end{itemize}
\begin{itemize}
	\item Bootsrap It will be used for the styling of the web page 
\end{itemize}
\begin{itemize}
	\item Web browsers: Any web browser that supports HTML 5
\end{itemize}
