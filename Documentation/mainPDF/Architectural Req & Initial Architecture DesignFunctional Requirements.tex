...
\end{itemize}
\begin{itemize}
	\item \textit{AngularJS:} To implement the MVC pattern in the front end
\end{itemize}
\begin{itemize}
...
\begin{itemize}
	\item \textit{Karma and Jasmine:} It is a powerful framework for javaScript unit testing in angular, it is easy to use and It can test any generic javaScript code
\end{itemize}
%Sandile's Section End
