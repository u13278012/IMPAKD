...
\includegraphics[width=1\textwidth]{./Images/addProperty.png}
\subsubsection{deleteProperty}
\includegraphics[width=1\textwidth]{./Images/deleteProperty.png}
\subsubsection{updateProperty}
\includegraphics[width=1\textwidth]{./Images/updateProperty.png}
% Diana's Section - end
